...

{
   ...
   static void sittplatser() {
    ...
    static void bokning() {
        ...
        int sittplats = helium1.nextInt();
        System.out.println("Skriv personummer:ÅÅÅÅMMDD");
        int persnum = helium1.nextInt();
        helium1.nextLine();
        System.out.println("Skriv in namn:För/efter");
        String namn = helium1.nextLine();
        System.out.println("Skriv in Kön:M/K");
        String kön = helium1.nextLine();
    ...
    static void avbokning(int persbort) {
        ...
        public static void sorteing(){
            ...
            for(int i=0; i<personummerplatserålder.length; i++){
                System.out.println(personummerplatserålder[i]);

            }
            for(int i=0; i<personummerplatserålder.length; i++){
                System.out.println(personummerplatser[i]);
